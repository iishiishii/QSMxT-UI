...
const helperText = (
  <Text>View the logs of ongoing and historical jobs by clicking on them</Text>
);
...
const ViewRuns = () => {
  ...
  const openedView = openView === "history" ? openView : "queue";

  const [view, setView]: [string, (view: string) => void] =
    useState(openedView);
