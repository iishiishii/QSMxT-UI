...
const CreateCohort: React.FC = () => {
  ...
  return (
    <>
      ...
      <Form
        name="cohortCreation"
        onFinish={({ cohortName, cohortDescription }) =>
          createCohort(cohortName, cohortDescription)
        }
        autoComplete="off"
      >
        {/* Cohort Name */}
        <Form.Item
          ...
          label="Cohort Name"
        >
          <Input placeholder="Enter a cohort name..." />
        </Form.Item>
        {/* Description */}
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "Please input the description for the cohort",
            },
          ]}
          label="Description"
        >
          <Input placeholder="Enter a cohort description..." />
        </Form.Item>
        <Form.Item>
          <Button
            style={{ width: "100%" }}
